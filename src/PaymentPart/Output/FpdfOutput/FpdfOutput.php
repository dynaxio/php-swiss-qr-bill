...
final class FpdfOutput extends AbstractOutput implements OutputInterface
{
    ...
    private function addInformationContentReceipt(): void
    {
        ...
        $this->fpdf->MultiCell(0, 7, (Translation::get('receipt', $this->language)));
        ...
        $this->fpdf->Cell(54, 0, (Translation::get('acceptancePoint', $this->language)), self::BORDER, '', self::ALIGN_RIGHT);
    }
    ...
    private function addInformationContent(): void
    {
        ...
        $this->fpdf->MultiCell(48, 7, (Translation::get('paymentPart', $this->language)));
    ...
    private function addSeparatorContentIfNotPrintable(): void
    {
        if (!$this->isPrintable()) {
            ...
            $this->fpdf->SetFont(self::FONT, '', self::FONT_SIZE_FURTHER_INFORMATION);
            $this->setY(189.6);
            $this->fpdf->MultiCell(0, 0, (Translation::get('separate', $this->language)), self::BORDER, self::ALIGN_CENTER);
        }
    }
